    ...
    for ( SimHitFxTicker = SimHitFxTicker; SimHitFxTicker != HitFxTicker; SimHitFxTicker = (SimHitFxTicker + 1) % ArrayCount(HitFX) )
    {
        ...
        if( HitFX[SimHitFxTicker].bSever )
        {
            ...
            switch( HitFX[SimHitFxTicker].bone )
            {
                case 'Bip01 L Thigh':
                case 'Bip01 R Thigh':
                    Spawn(class'KFOldSchoolZedsMod.BrainSplashOS',,,boneCoords.Origin,Self.Rotation); //KFMod Brainsplash
...
simulated function DecapFX( Vector DecapLocation, Rotator DecapRotation, bool bSpawnDetachedHead, optional bool bNoBrainBits )
{
    ...
    if ( !bSpawnDetachedHead && !bNoBrainBits && EffectIsRelevant(DecapLocation,false) )
    {
        ...
        SpawnGiblet( class 'KFOldSchoolZedsMod.KFGibBrainOS',DecapLocation, self.Rotation, GibPerterbation) ;
        SpawnGiblet( class 'KFOldSchoolZedsMod.KFGibBrainbOS',DecapLocation, self.Rotation, GibPerterbation) ;
        SpawnGiblet( class 'KFOldSchoolZedsMod.KFGibBrainOS',DecapLocation, self.Rotation, GibPerterbation) ;
    }
    ...
    if ( Level.NetMode!=NM_DedicatedServer )
    {
        ...
        if(bDecapitated && !bPlayBrainSplash )
        {
            ...
            if ( EffectIsRelevant(Location,false) )
            {
                ...
                SpawnGiblet( class 'KFOldSchoolZedsMod.KFGibBrainOS',SplatLocation, self.Rotation, GibPerterbation ) ;
                SpawnGiblet( class 'KFOldSchoolZedsMod.KFGibBrainbOS',SplatLocation, self.Rotation, GibPerterbation ) ;
                SpawnGiblet( class 'KFOldSchoolZedsMod.KFGibBrainOS',SplatLocation, self.Rotation, GibPerterbation ) ;
            }
        ...
        if (Gored>0 && !bPlayGoreSplash)
        {
            ...
            {
                //Use KFMod classes
                Spawn(class'KFOldSchoolZedsMod.BrainSplashOS',,,SplatLocation,Self.Rotation);
                SpawnGiblet( class 'KFOldSchoolZedsMod.KFGibBrainOS',SplatLocation, self.Rotation, GibPerterbation ) ;
                SpawnGiblet( class 'KFOldSchoolZedsMod.KFGibBrainbOS',SplatLocation, self.Rotation, GibPerterbation ) ;
                SpawnGiblet( class 'KFOldSchoolZedsMod.KFGibBrainOS',SplatLocation, self.Rotation, GibPerterbation ) ;
            }
            ...
            //    Log("CHUNKED UP!");
                                ...
                                Spawn(class'KFOldSchoolZedsMod.BodySplashOS',,,SplatLocation,Self.Rotation);
...
function ClawDamageTarget()
{
    ...
    //More or less the same as KFMod's code
...
event KImpact(actor other, vector pos, vector impactVel, vector impactNorm)
{
    ...
    if ( WallActor != None && Level.TimeSeconds > LastStreakTime + BloodStreakInterval && !class'GameInfo'.static.UseLowGore() )
    {
        ...
        Streak = spawn(class 'KFOldSchoolZedsMod.KFBloodStreakDecalOS',,, WallHit, rotator(-WallNormal));
...
defaultproperties
{
    ...
    HeadStubClass=Class'KFOldSchoolZedsMod.GibHeadStumpOS'
    ...
    // The Giblets that spawn after an obliteration, KFMod ones
     MonsterHeadGiblet=Class'KFOldSchoolZedsMod.ClotGibHeadOS'
     MonsterThighGiblet=Class'KFOldSchoolZedsMod.ClotGibThighOS'
     MonsterArmGiblet=Class'KFOldSchoolZedsMod.ClotGibArmOS'
     MonsterLegGiblet=Class'KFOldSchoolZedsMod.ClotGibLegOS'
     MonsterTorsoGiblet=Class'KFOldSchoolZedsMod.ClotGibTorsoOS'
     MonsterLowerTorsoGiblet=Class'KFOldSchoolZedsMod.ClotGibLowerTorsoOS'
     
     //How Heavy a zed is
     Mass=300.000000//100.000000 in parent
     
     //Gib group containing Blood Splatter
     GibGroupClass=Class'KFOldSchoolZedsMod.KFNoGibGroupOS'
     ...
     //Blood Spurt Class
     ProjectileBloodSplatClass=class'KFOldSchoolZedsMod.KFBloodPuffOS'
     
     //Use my own Controller Class
     ControllerClass=Class'KFOldSchoolZedsMod.KFMonsterControllerOS'
     ...
     End Object
     KParams=KarmaParamsSkel'KFOldSchoolZedsMod.KFMonsterOS.PawnKParams'     
